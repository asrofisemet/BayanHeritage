...
<head>
    ...
    <title>Detail Tempat Kuliner Admin</title>
...
<body class="flex min-h-screen bg-[#FFFFFF] font-josefin">
    ...
    <aside class="text-[#FFC107] w-20 flex flex-col items-center fixed top-0 left-0 h-screen z-20 bg-[#FFFFFF]">
        ...
        <div class="flex-1 p-5 space-y-6">
            <div href="HomePageAdmin.php" class="w-12 h-12 rounded flex items-center justify-center font-bold cursor-pointer transition hover:scale-110 hover:bg-gray-100">
    ...
    <main class="flex-1 pt-3 overflow-y-auto ml-20">
        <div id="main-content-area" class="min-h-screen p-6 md:p-8 shadow-2xl w-full">
            ...
            <div id="awal">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg mb-4 border border-[#F0BC53]">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="md:w-2/3">
                            <div class="text-yellow-500 my-1 text-lg rating" data-rating="4"></div>
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg md:max-w-xl relative">
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="flex justify-center">
                    <div id="closeEditMenu" class="bg-[#FF9800] text-white font-bold hover:bg-[#FF9800]/80 hover:text-white/80 px-7 py-1 rounded-full">
                        Save
                    </div>
                </div>
            </div>
    ...
    <div id="editPromoModal" class="hidden modal-overlay fixed inset-0 bg-black bg-opacity-50 justify-center items-center z-50 p-4">
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg md:max-w-xl relative">
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="md:w-2/3 flex flex-col">
                    <input type="text" value="Buy 2 Get 3" class="text-2xl md:text-xl font-bold text-[#5C3211] mb-2 opacity-50 bg-transparent focus:outline-none w-full"/>
                    <textarea class="text-md font-light text-[#5C3211] leading-relaxed opacity-50 bg-transparent border-none focus:outline-none resize-none w-full" rows="1">Buy 2 serving get 3 serving of Es Campur</textarea>
                    <input type="text" value="Valid until: 10 November 2025" class="text-lg font-normal text-[#5C3211] mb-2 opacity-50 bg-transparent w-full border-none focus:outline-none" />
                </div>
                <hr class="border-[#5C3211] mb-4">
