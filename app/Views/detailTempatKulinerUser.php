...
<body class="flex min-h-screen bg-[#FFFFFF] font-josefin">
    ...
    <aside class="text-[#FFC107] w-20 flex flex-col items-center fixed top-0 left-0 h-screen z-20 bg-[#FFFFFF]">
        ...
        <div class="flex-1 p-5 space-y-6">
            <a href="<?= base_url('/homeuser') ?>" class="w-12 h-12 rounded flex items-center justify-center font-bold cursor-pointer transition hover:scale-110 hover:bg-gray-100">
    ...
    <div id="sidebarMenu" class="text-[#FFC107] fixed top-0 w-72 h-screen bg-[#FFFFFF] backdrop-blur-md z-[200] flex flex-col duration-300 ease-in-out -translate-x-full">
        ...
        <div class="flex-1 p-5 space-y-6">
            <a href="<?= base_url('/homeuser') ?>" class="flex items-center rounded cursor-pointer transition hover:scale-110 hover:bg-gray-100">
    ...
    <main class="flex-1 pt-3 overflow-y-auto ml-20">
        <div id="main-content-area" class="min-h-screen p-6 md:p-8 shadow-2xl w-full">
            ...
            <div id="awal">
                <h1 class="text-3xl md:text-4xl font-bold text-[#FFFFFF] text-center [text-shadow:1px_1px_3px_rgba(0,0,0,0.5)]">RM Sumber Rejeki</h1>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg mb-8 border border-[#F0BC53]">
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="md:w-1/3 flex-shrink-0">
                            <img src="<?= base_url('Assets/sumber_rejeki.png') ?>" alt="Selong Belanak Beach" class="rounded-xl w-full h-auto object-cover shadow-md mb-3">
                            <p class="text-sm text-[#5C3211] mb-1 font-bold">Jl. Mareje, Panjisari, Kec. Praya, Kabupaten Lombok Tengah, Nusa Tenggara Bar. 83511</p>
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <p class="text-base font-semibold text-[#5C3211] mb-4 leading-relaxed">
                                Pegawainya ramah, pagi2 menu sudah banyak yang siap, tempatnya bersih, kalau untuk rasa saya agak kurang cocok, makanan yang saya pesan rawon dan gulai kambing.
                            </p>
                            <img src="<?= base_url('Assets/review_sumberRejeki.png') ?>" alt="Review Image" class="rounded-xl w-80 h-52 object-cover shadow-md mb-3">
                        </div>
                    </div> 
                </div>
            </div>
            ...
            <div id="ratingModal" class="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4 hidden">
                <div class="bg-white p-4 rounded-2xl shadow-2xl border border-[#5C3211]/30 w-full max-w-lg relative text-[#5C3211]">
                    <div class="border border-[#5C3211] rounded-xl p-6 relative">
                        <button id="closeRating" class="absolute top-3 left-3 w-7 h-7 rounded-full border border-[#5C3211] flex items-center justify-center text-[#5C3211] hover:bg-gray-100 hover:text-[#8E5E38] transition focus:outline-none">
            ...
            <div id="claimForm" class="header mb-5 hidden">
                ...
                <form action="<?= base_url('/kulineruser/klaimTempat') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded-xl p-5 mb-4 shadow-[-2px_2px_3px_0_rgba(0,0,0,0.1),-1px_1px_2px_0_rgba(0,0,0,0.06)] border border-[#F0D3B3]">
                        ...
                        <input id="file-upload" type="file" multiple class="hidden" name="dokumen_pendukung"/>
            ...
            <div id="addPlace" class="header mb-5 hidden">
                ...
                <div class="bg-white rounded-xl p-5 mb-4 shadow-[-2px_2px_3px_0_rgba(0,0,0,0.1),-1px_1px_2px_0_rgba(0,0,0,0.06)] border border-[#F0D3B3]">
                    ...
                    <input id="file-upload-claim" type="file" multiple class="hidden"/>
                    <p id="file-list-claim" class="text-xs text-gray-500 mt-2"></p> 
                </div>
            ...
            <div id="profil" class="header mb-5 hidden">
                <div id="containerProfile" class="bg-[#FFFFFF] rounded-xl p-4 flex items-center justify-between shadow-md overflow-hidden mt-8 border border-[#F0D3B3]">
                    <div id="profilPage" class="flex items-center w-full relative">
                        <button id="editProfileBtn" class="absolute top-4 right-4 bg-[#FF9800] text-[#FFFFFF] hover:bg-[#FF9800]/80 hover:text-[#FFFFFF]/80 px-7 py-1 rounded-full shadow font-semibold flex items-center gap-2 transition">Edit</button>
                    ...
                    <!-- 'SAYA TAMBAHIN BUTTON CANCEL DISINI, SUDAH JUGA DITAMBAH DI HOMEPAGE USER DAN PEMILIK' -->
                    <div id="editProfilePage" class="flex items-center w-full relative hidden">
                        <div class="absolute top-4 right-4 flex items-center gap-3">
                            ...
                            <button id="saveEditBtn" class="border border-[#FF9800] text-[#FF9800] hover:bg-[#FF9800]/80 hover:text-white/80 px-7 py-1 rounded-full shadow font-semibold flex items-center gap-2 transition">
                                Save change
                            </button>
                        </div>
    ...
    <div id="menuModal" class="hidden modal-overlay fixed inset-0 bg-black bg-opacity-50 justify-center items-center z-50 p-4">
        
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg md:max-w-xl relative">
            
            <button id="closeMenu" class="absolute top-3 right-3 text-[#5C3211] hover:opacity-50 text-2xl">
            ...
            <div class="p-6 md:p-8">
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="md:w-1/3 flex-shrink-0">
                        <img src="<?= base_url('Assets/Pelecing.png') ?>"
                             alt="Pelecing Kangkung" 
                             class="w-32 h-32 object-cover rounded-md aspect-square">
                             </div>

                    <div class="md:w-2/3 flex flex-col">
                        <h2 class="text-2xl md:text-xl font-bold text-[#5C3211] mb-2">Pelecing Kangkung</h2>
                        <p class="text-md font-light text-[#5C3211] leading-relaxed mb-3">
                            Kale (kangkung) blanched (or steamed) and served cold with spicy tomato chili sauce
                        </p>
                        <p class="text-lg font-normal text-[#5C3211] mt-2 mb-2">
                            Rp10.000/serving
                        </p>
                    </div>
                </div>
                ...
                <p class="text-center text-[#5C3211] font-light text-base mt-4">
                    That's all.
                </p>
            </div>
    ...
    <div id="promoModal" class="hidden modal-overlay fixed inset-0 bg-black bg-opacity-50 justify-center items-center z-50 p-4">
        
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg md:max-w-xl relative">
            
            <button id="closePromo" class="absolute top-3 right-3 text-[#5C3211] hover:opacity-50 text-2xl">
                <i class="fas fa-xmark"></i>
            </button>

            <div class="p-6 md:p-8">
                <div class="md:w-2/3 flex flex-col">
                    <h2 class="text-2xl md:text-xl font-bold text-[#5C3211] mb-1">Diskon 30%</h2>
                    <p class="text-md font-light text-[#5C3211] leading-relaxed mb-2">
                        Every purchase of 2 servings Pelecing Kangkung
                    </p>
                    <p class="text-lg font-medium text-[#5C3211] mb-2">
                        Valid until: 2 December 2025
                    </p>
                </div>
                <hr class="border-[#5C3211] mb-4">

                <div class="md:w-2/3 flex flex-col">
                    <h2 class="text-2xl md:text-xl font-bold text-[#5C3211] mb-1">Buy 2 Get 3</h2>
                    <p class="text-md font-light text-[#5C3211] leading-relaxed mb-2">
                        Buy 2 serving get 3 serving of Es Campur
                    </p>
                    <p class="text-lg font-medium text-[#5C3211] mb-2">
                        Valid until: 10 November 2025
                    </p>
                </div>
                <hr class="border-[#5C3211] mb-4">

                <p class="text-center text-[#5C3211] font-light text-base">
                    That's all.
                </p>
            </div>
