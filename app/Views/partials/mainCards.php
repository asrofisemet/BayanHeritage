<?php // JIKA $categories belum terdefinisi, tambahkan fallback atau definisi di sini atau di controller
if (!isset($categories)) {
    $categories = [
        'tourist_destination' => [
...
// JIKA $current_query belum terdefinisi, tambahkan fallback
if (!isset($current_query)) {
    $current_query = request()->getGet();
}
$active_category = $current_query['category'] ?? ''; // Menggunakan $current_query dari atas
